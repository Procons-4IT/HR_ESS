<%@ Page Title="Permission/Leave by hours Request" Language="vb" AutoEventWireup="false" MasterPageFile="~/HRMS.Master" CodeBehind="PermissionRequest.aspx.vb" Inherits="HRMS.PermissionRequest" %>
            ...
            <table width="99%" border="0" cellspacing="0" cellpadding="4" class="main_content">
              ...
              <td valign="top">  
                ...
                <%--  <asp:TemplateField HeaderText="Leave Code" Visible="false">
                  <ItemTemplate>
                  <div align="center"><asp:label ID="lbllvecode" runat="server" Text='<%#Bind("U_Z_TrnsCode") %>'  ></asp:label></div>
                  </ItemTemplate>
                  </asp:TemplateField>
                  <asp:TemplateField HeaderText="Leave Type" Visible="false">
                  <ItemTemplate>
                  <div align="center"><asp:label ID="lbllvetype" runat="server" Text='<%#Bind("Name") %>'  ></asp:label></div>
                  </ItemTemplate>
                  </asp:TemplateField>--%>
                  ...
                  <ItemTemplate>
                  <div align="left">&nbsp;<asp:Label ID="lbledDate" runat="server" Text='<%#Bind("U_Z_EndDate") %>' ></asp:Label></div>
                  </ItemTemplate>
                  </asp:TemplateField>
                  <asp:TemplateField HeaderText="From Time">
                  <ItemTemplate>
                  <div align="left">&nbsp;<asp:Label ID="lblfrtime" runat="server" Text='<%#Bind("U_Z_FromTime") %>' ></asp:Label></div>
                  </ItemTemplate>
                  </asp:TemplateField>
                  ...
                  <ItemTemplate>
                  <div align="left">&nbsp;<asp:Label ID="lblreason" runat="server" Text='<%#Bind("U_Z_Notes") %>' ></asp:Label></div>
                  </ItemTemplate>
                  </asp:TemplateField>
...
<ajx:ModalPopupExtender ID="ModalPopupExtender7" runat="server" DropShadow="True" PopupControlID="Panelpoptechnician" TargetControlID="btnSample" CancelControlID="btnclstech" BackgroundCssClass="modalBackground">
 ...
 <td>
  <asp:Panel ID="Panelpoptechnician" runat="server" BackColor="White" style=" display:none; padding:10px; width:900px; ">
                              ...
                              <br /><asp:Panel ID="Panel4" runat="server" Height="400px" >
