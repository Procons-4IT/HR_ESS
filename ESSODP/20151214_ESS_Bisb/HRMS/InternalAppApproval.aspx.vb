...
Imports DataAccess
Imports EN
Public Class InternalAppApproval
    ...
    Protected Sub lbtndocnum_Click(ByVal sender As Object, ByVal e As EventArgs)
        ...
        Else
            ...
            Dim deptcode As Label = CType(gv.FindControl("lblempdeptcode"), Label)
            Dim EmpId As Label = CType(gv.FindControl("lblempcode"), Label)
            ...
            txtdepid.Text = deptcode.Text.Trim()
            txtintempid.Text = EmpId.Text.Trim()
            objEN.InternalEmpInd = txtintempid.Text.Trim()
            objEN.EmpId = Session("UserCode").ToString()
    ...
    Private Sub btnAdd_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnAdd.Click
        Try
            ...
            ElseIf txtcode.Text <> "" Or txtcode.Text <> Nothing Then
                ...
                objEN.EmpId = txtdepid.Text.Trim()
                objEN.HistoryType = "IntAppReq"
                objEN.HeaderType = "Rec"
                objEN.InternalEmpInd = txtintempid.Text.Trim()
