                                                        ...
                                                        <ajx:TabContainer ID="TabContainer1" runat="server" ActiveTabIndex="0" CssClass="ajax__tab_yuitabview-theme"
                                                            ...
                                                            <ajx:TabPanel ID="TabPanel5" runat="server" HeaderText="Expenses Claim Request">
                                                                <ContentTemplate>
                                                                    <table width="100%" border="0" cellspacing="0" cellpadding="4" class="main_content">
                                                                        <tr>
                                                                            <td id="NewExpense" runat="server" align="left">
                                                                        ...
                                                                        <tr>
                                                                            <td>
                                                                                <asp:GridView ID="grdRequestExpenses" runat="server" CellPadding="4" RowStyle-CssClass="mousecursor"
                                                                                    CssClass="mGrid" HeaderStyle-CssClass="GridBG" PagerStyle-CssClass="pgr" AutoPostback="flash"
                                                                                    AllowPaging="true" PageSize="15" AlternatingRowStyle-CssClass="mousecursor" AutoGenerateColumns="false"
                                                                                ...
                                                                                <asp:GridView ID="grdApproved" runat="server" CellPadding="4" RowStyle-CssClass="mousecursor"
                                                                                    ...
                                                                                    <Columns>
                                                                                        ...
                                                                                        <asp:TemplateField HeaderText="Current Approver">
                                                                                            <ItemTemplate>
                                                                                                <div align="left">
                                                                                                    &#160;<asp:Label ID="lblcurapp1" runat="server" Text='<%#Bind("U_Z_CurApprover") %>'></asp:Label></div>
                                                                                            </ItemTemplate>
                                                                                        </asp:TemplateField>
                                                                                        <asp:TemplateField HeaderText="Next Approver">
                                                                                            <ItemTemplate>
                                                                                                <div align="left">
                                                                                                    &#160;<asp:Label ID="lblnxtapp1" runat="server" Text='<%#Bind("U_Z_NxtApprover") %>'></asp:Label></div>
                                                                                            </ItemTemplate>
                                                                                        </asp:TemplateField>
                                                                                ...
                                                                                <asp:GridView ID="grdRejected" runat="server" CellPadding="4" RowStyle-CssClass="mousecursor"
                                                                                    ...
                                                                                    <Columns>
                                                                                        ...
                                                                                        <asp:TemplateField HeaderText="Current Approver">
                                                                                            <ItemTemplate>
                                                                                                <div align="left">
                                                                                                    &#160;<asp:Label ID="lblcurapp2" runat="server" Text='<%#Bind("U_Z_CurApprover") %>'></asp:Label></div>
                                                                                            </ItemTemplate>
                                                                                        </asp:TemplateField>
                                                                                        <asp:TemplateField HeaderText="Next Approver">
                                                                                            <ItemTemplate>
                                                                                                <div align="left">
                                                                                                    &#160;<asp:Label ID="lblnxtapp2" runat="server" Text='<%#Bind("U_Z_NxtApprover") %>'></asp:Label></div>
                                                                                            </ItemTemplate>
                                                                                        </asp:TemplateField>
                                                                                        <asp:TemplateField HeaderText="Approval History">
                                                                                            <ItemTemplate>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <asp:TextBox ID="txttrasamt" CssClass="txtbox" runat="server" autocomplete="off"
                                                    AutoPostBack="true" onkeypress="AllowNumbers(this);checkDec(this);RemoveZero(this);"
