<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/HRMS.Master"
    CodeBehind="Home.aspx.vb" Inherits="HRMS.Home" Theme="Theme1" %>
                ...
                <tr>
                                ...
                                <td>
                                    ...
                                    <asp:Panel ID="panelview" runat="server" Width="100%">
                                        <table width="99%" border="0" cellspacing="0" cellpadding="4" class="main_content">
                                            <tr>
                                                <td valign="top">
                                                    <ajx:TabContainer ID="TabContainer2" runat="server" Width="100%" CssClass="ajax__tab_yuitabview-theme"
                                                        ActiveTabIndex="0">
                 ...
                 <td>
                  <asp:Label ID="txtjobtitle" CssClass="txtbox" Width="150px"  runat="server" ></asp:Label>
                                                                        ...
                                                                        <td>
                                                                            <asp:Label ID="txtposition" CssClass="txtbox" Width="150px" runat="server" Visible="false"></asp:Label>
                                                                            <asp:Label ID="lblposName" CssClass="txtbox" Width="150px" runat="server"></asp:Label>
                                                                        </td>
                                                                        <td width="15%">
                                                                        </td>
                                                                        <td width="10%">
                  ...
                  <td width="30%">
                   <asp:Label ID="txtExt"  CssClass="txtbox" Width="150px"  runat="server"></asp:Label>        
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <asp:Label ID="txtdept" CssClass="txtbox" Width="150px" runat="server" Visible="false"></asp:Label>
                                                                            <asp:Label ID="lbldeptName" CssClass="txtbox" Width="150px" runat="server"></asp:Label>
                                                                        </td>
                                                                        <td width="15%">
                                                                        </td>
                                                                        <td width="10%">
                  ...
                  <td width="30%">
                   <asp:Label ID="txtpager"  CssClass="txtbox" Width="150px" runat="server"></asp:Label>        
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <asp:Label ID="lblgrade" CssClass="txtbox" Width="150px" runat="server"></asp:Label>
                                                                        </td>
                                                                        <td width="15%">
                                                                        </td>
                                                                        <td width="10%">
                                                                        ...
                                                                        <td width="30%">
                                                                            <asp:Label ID="lblSalScale" CssClass="txtbox" Width="150px" runat="server"></asp:Label>
                                                                        </td>
                                                                    </tr>
                                                                </table>
                                                            </ContentTemplate>
                                                        </ajx:TabPanel>
                                                        <ajx:TabPanel ID="TabPanel4" runat="server" HeaderText="Internal Job Postings">
                                                            <ContentTemplate>
                                                                <table width="100%" border="0" cellspacing="0" cellpadding="4" class="main_content">
                                                                    <tr>
                                                                        <td align="center">
                                                                            ...
                                                                            <div id="Empdetails" runat="server" class="DivCorner" style="width: 99%;">
                                                                                <div id="Emp" runat="server" visible="False">
                                                                                    <table border="0" cellspacing="0" cellpadding="4" class="main_content">
                                                                                        ...
                                                                                        <tr style="visibility: collapse;">
                                                                                            ...
                                                                                            <td>
                                                                                                <asp:TextBox ID="TextBox1" CssClass="txtbox" Width="150px" ReadOnly="True" runat="server"></asp:TextBox>
                                                                                            </td>
                                                                                            <td width="15%">
                                                                                            </td>
                                                                                            <td width="12%">
                                                                                            ...
                                                                                            <td width="20%">
                                                                                                <asp:TextBox ID="txtdeptname" CssClass="txtbox" Width="150px" ReadOnly="True" runat="server"></asp:TextBox>
                                                                                            </td>
                                                                                        </tr>
                                                                                    </table>
                                                                                </div>
                                                                                <table border="0" cellspacing="0" cellpadding="4" class="main_content">
                                                                                    <tr>
                                                                                        <td>
                                                                                            <a style="font-family: Verdana; font-size: 11pt; font-weight: bold; text-decoration: underline">
                                                                                                Vacant positions</a>
                                                                                        </td>
                                                                                    </tr>
                                                                                    <tr>
                                                                                        <td>
                                                                                            <div style="overflow-x: auto; width: 1100px;">
                                                                                                <asp:GridView ID="GridView2" runat="server" CellPadding="4" ShowHeaderWhenEmpty="True"
                                                                                                    EmptyDataText="No records Found" CssClass="mGrid" AutoGenerateSelectButton="True"
                                                                    ...
                                                                    <tr>
                                                                        <td align="right">
                                                                            <br />
                                                                            <asp:Button ID="btnsubmit" CssClass="btn" Width="85px" runat="server" Text="Apply"
                                                                    ...
                                                                    <tr>
                                                                        <td>
                                                                            <div style="overflow-x: auto;">
                                                                                <asp:GridView ID="grdScheduled" runat="server" CellPadding="4" CssClass="mGrid" ShowHeaderWhenEmpty="true"
                                                                                    EmptyDataText="No records Found" PagerStyle-CssClass="pgr" HeaderStyle-CssClass="GridBG"
                                                                                    ...
                                                                                    <Columns>
                                                                                        <asp:TemplateField HeaderText="Requisition Code">
                                                                                            <ItemTemplate>
                                                                                                <div align="left">
                                                                                                    &nbsp;<asp:Label ID="lblreqcode" runat="server" Text='<%#Bind("U_RequestCode") %>'></asp:Label></div>
                                                                                            </ItemTemplate>
                                                                                        </asp:TemplateField>
                                                                                        <asp:TemplateField HeaderText="Employee Code">
                                                                                            <ItemTemplate>
                                                                                                <div align="left">
                                                                                                    &nbsp;<asp:Label ID="lblcouCode" runat="server" Text='<%#Bind("U_Empid") %>'></asp:Label></div>
                                                                                            </ItemTemplate>
                                                                                        </asp:TemplateField>
                                                                                        ...
                                                                                        <asp:TemplateField HeaderText="Department">
                                                                                            <ItemTemplate>
                                                                                                <div align="center">
                                                                                                    &nbsp;<asp:Label ID="lbldeptname" runat="server" Text='<%#Bind("U_ReqdeptName") %>'></asp:Label></div>
                                                                                            </ItemTemplate>
                                                                                        </asp:TemplateField>
                                                                                        <asp:TemplateField HeaderText="Position">
                                                                                            <ItemTemplate>
                                                                                                <div align="left">
                                                                                                    <asp:Label ID="lblposname" runat="server" Text='<%#Bind("U_EmpPosName") %>'></asp:Label>&nbsp;&nbsp;</div>
                                                                                            </ItemTemplate>
                                                                                        </asp:TemplateField>
                                                                                        <asp:TemplateField HeaderText="Status">
                                                                                            <ItemTemplate>
                                                                                                <div align="center">
                                                                                                    &nbsp;<asp:Label ID="lblstatus3" runat="server" Text='<%#Bind("U_Z_AppStatus") %>'></asp:Label></div>
                                                                                            </ItemTemplate>
                                                                                        </asp:TemplateField>
                                                                                        <asp:TemplateField HeaderText="Remarks">
                                                                                            <ItemTemplate>
                                                                                                <div align="left">
                                                                                                    &nbsp;<asp:Label ID="lblReason" runat="server" Text='<%#Bind("U_Remarks") %>'></asp:Label></div>
                                                                                            </ItemTemplate>
                                                                                        </asp:TemplateField>
                                                                                    </Columns>
                                                                ...
                                                                <table width="100%" border="0" cellspacing="0" cellpadding="3" class="main_content">
                                                                    <tr>
                                                                        <td style="padding-top: 10px;">
                                                                            <asp:GridView ID="grdRequestApp" runat="server" CellPadding="4" ShowHeaderWhenEmpty="true"
                                                                                EmptyDataText="No records Found" CssClass="mGrid" HeaderStyle-CssClass="GridBG"
                                                                                AllowPaging="True" AutoGenerateColumns="False" Width="100%" PageSize="10">
                                                                                <Columns>
                                                                                    <asp:TemplateField HeaderText="Appraisal No.">
                                                                                        <ItemTemplate>
                                                                                            <div align="center">
                                                                                                <asp:Label ID="lbtndocnum" runat="server" Text='<%#Bind("DocEntry") %>'></asp:Label></div>
                                                                                        </ItemTemplate>
                                                                                    </asp:TemplateField>
                                                                                    <asp:TemplateField HeaderText="Request Date">
                                                                                        <ItemTemplate>
                                                                                            <div align="left">
                                                                                                &nbsp;<asp:Label ID="lblcust" runat="server" Text='<%#Bind("U_Z_Date") %>'></asp:Label></div>
                                                                                        </ItemTemplate>
                                                                                    </asp:TemplateField>
                                                                                    ...
                                                                                    <asp:TemplateField HeaderText="Period">
                                                                                        <ItemTemplate>
                                                                                            <div align="left">
                                                                                                &nbsp;<asp:Label ID="lblitemdesc" runat="server" Text='<%#Bind("U_Z_Period") %>'></asp:Label></div>
                                                                                        </ItemTemplate>
                                                                                    </asp:TemplateField>
                                                                                    <asp:TemplateField HeaderText="Active">
                                                                                        <ItemTemplate>
                                                                                            <div align="center">
                                                                                                &nbsp;<asp:Label ID="lblserial" runat="server" Text='<%#Bind("U_Z_Status") %>'></asp:Label></div>
                                                                                        </ItemTemplate>
                                                                                    </asp:TemplateField>
                                                                                    <asp:TemplateField HeaderText="Status">
                                                                                        <ItemTemplate>
                                                                                            <div align="center">
                                                                                                &nbsp;<asp:Label ID="lblstatus" runat="server" Text='<%#Bind("U_Z_WStatus") %>'></asp:Label></div>
                                                                                        </ItemTemplate>
                                                                                    </asp:TemplateField>
                                                                                    <asp:TemplateField HeaderText="Grievance No" Visible="false">
                                                                                        <ItemTemplate>
                                                                                            <div align="left">
                                                                                                &nbsp;<asp:Label ID="lblgrvno" runat="server" Text='<%#Bind("U_Z_GNo") %>'></asp:Label></div>
                                                                                        </ItemTemplate>
                                                                                    </asp:TemplateField>
                                                                                    <asp:TemplateField HeaderText="Grievance Remarks" Visible="false">
                                                                                        <ItemTemplate>
                                                                                            <div align="left">
                                                                                                &nbsp;<asp:Label ID="lblgrvremarks" runat="server" Text='<%#Bind("U_Z_GRemarks") %>'></asp:Label></div>
                                                                                        </ItemTemplate>
                                                                                    </asp:TemplateField>
                                                                                    <asp:TemplateField HeaderText="Grievance date" Visible="false">
                                                                                        <ItemTemplate>
                                                                                            <div align="center">
                                                                                                &nbsp;<asp:Label ID="lblgrvdate" runat="server" Text='<%#Bind("U_Z_GDate") %>'></asp:Label></div>
                                                                                        </ItemTemplate>
                                                                                    </asp:TemplateField>
                                                                                    <asp:TemplateField HeaderText="Grievance Status" Visible="false">
                                                                                        <ItemTemplate>
                                                                                            <div align="center">
                                                                                                &nbsp;<asp:Label ID="lblgrvstatus" runat="server" Text='<%#Bind("U_Z_GStatus") %>'></asp:Label></div>
                                                                                        </ItemTemplate>
                                                                                    </asp:TemplateField>
                                                                                </Columns>
                                                                                <HeaderStyle HorizontalAlign="Center" Height="25px" BackColor="#CCCCCC" />
                                                                    ...
                                                                    <tr>
                                                                        <td colspan="4">
                                                                            ...
                                                                            <asp:GridView ID="GridView1" runat="server" CellPadding="4" ShowHeaderWhenEmpty="true"
                                                                                EmptyDataText="No records Found" HeaderStyle-CssClass="GridBG" CssClass="mGrid"
                                                                                PagerStyle-CssClass="pgr" AlternatingRowStyle-CssClass="alt" AllowPaging="True"
                                                                                RowStyle-CssClass="mousecursor" AutoGenerateColumns="False" Width="100%" PageSize="10">
                                                                                <SelectedRowStyle BackColor="#FFA20C" />
                                                                                <Columns>
                                                                                    <asp:TemplateField HeaderText="Agenda Code">
                                                                                        <ItemTemplate>
                                                                                            <div align="left">
                                                                                                &nbsp;<asp:Label ID="lblTtracode" runat="server" Text='<%#Bind("U_Z_TrainCode") %>'></asp:Label></div>
                                                                                        </ItemTemplate>
                                                                                    </asp:TemplateField>
                                                                                    <asp:TemplateField HeaderText="Agenda Date">
                                                                                        <ItemTemplate>
                                                                                            <div align="left">
                                                                                                &nbsp;<asp:Label ID="lblTAgaDate" runat="server" Text='<%#Bind("U_Z_DocDate") %>'></asp:Label></div>
                                                                                        </ItemTemplate>
                                                                                    </asp:TemplateField>
                                                                                    <asp:TemplateField HeaderText="Course Code" Visible="false">
                                                                                        <ItemTemplate>
                                                                                            <div align="left">
                                                                                                &nbsp;<asp:Label ID="lblTcouCode" runat="server" Text='<%#Bind("U_Z_CourseCode") %>'></asp:Label></div>
                                                                                        </ItemTemplate>
                                                                                    </asp:TemplateField>
                                                                                    <asp:TemplateField HeaderText="Course Name">
                                                                                        <ItemTemplate>
                                                                                            <div align="left">
                                                                                                &nbsp;<asp:Label ID="lblTCouName" runat="server" Text='<%#Bind("U_Z_CourseName") %>'></asp:Label></div>
                                                                                        </ItemTemplate>
                                                                                    </asp:TemplateField>
                                                                                    <asp:TemplateField HeaderText="Course Type">
                                                                                        <ItemTemplate>
                                                                                            <div align="center">
                                                                                                &nbsp;<asp:Label ID="lblTCouType" runat="server" Text='<%#Bind("U_Z_CourseTypeDesc") %>'></asp:Label></div>
                                                                                        </ItemTemplate>
                                                                                    </asp:TemplateField>
                                                                                    <asp:TemplateField HeaderText="Course Start Date">
                                                                                        <ItemTemplate>
                                                                                            <div align="left">
                                                                                                <asp:Label ID="lblTfromdt" runat="server" Text='<%#Bind("U_Z_Startdt") %>'></asp:Label>&nbsp;&nbsp;</div>
                                                                                        </ItemTemplate>
                                                                                    </asp:TemplateField>
                                                                                    <asp:TemplateField HeaderText="Course End Date">
                                                                                        <ItemTemplate>
                                                                                            <div align="center">
                                                                                                &nbsp;<asp:Label ID="lblTtodt" runat="server" Text='<%#Bind("U_Z_Enddt") %>'></asp:Label></div>
                                                                                        </ItemTemplate>
                                                                                    </asp:TemplateField>
                                                                                    <asp:TemplateField HeaderText="Min.Attendees">
                                                                                        <ItemTemplate>
                                                                                            <div align="left">
                                                                                                &nbsp;<asp:Label ID="lblTMinAtte" runat="server" Text='<%#Bind("U_Z_MinAttendees") %>'></asp:Label></div>
                                                                                        </ItemTemplate>
                                                                                    </asp:TemplateField>
                                                                                    <asp:TemplateField HeaderText="Max.Attendees">
                                                                                        <ItemTemplate>
                                                                                            <div align="left">
                                                                                                <asp:Label ID="lblTMax" runat="server" Text='<%#Bind("U_Z_MaxAttendees") %>'></asp:Label>&nbsp;&nbsp;</div>
                                                                                        </ItemTemplate>
                                                                                    </asp:TemplateField>
                                                                                    <asp:TemplateField HeaderText="Instructor Name">
                                                                                        <ItemTemplate>
                                                                                            <div align="left">
                                                                                                &nbsp;<asp:Label ID="lblTInstruction" runat="server" Text='<%#Bind("U_Z_InsName") %>'></asp:Label></div>
                                                                                        </ItemTemplate>
                                                                                    </asp:TemplateField>
                                                                                    <asp:TemplateField HeaderText="Application Start Date">
                                                                                        <ItemTemplate>
                                                                                            <div align="left">
                                                                                                &nbsp;<asp:Label ID="lblTStDate" runat="server" Text='<%# Eval("U_Z_AppStdt") %>'></asp:Label></div>
                                                                                        </ItemTemplate>
                                                                                    </asp:TemplateField>
                                                                                    <asp:TemplateField HeaderText="Application End Date">
                                                                                        <ItemTemplate>
                                                                                            <div align="left">
                                                                                                &nbsp;<asp:Label ID="lblTEndDate" runat="server" Text='<%# Eval("U_Z_AppEnddt") %>'></asp:Label></div>
                                                                                        </ItemTemplate>
                                                                                    </asp:TemplateField>
                                                                                    <asp:TemplateField HeaderText="No.of Hours">
                                                                                        <ItemTemplate>
                                                                                            <div align="left">
                                                                                                &nbsp;<asp:Label ID="lblThours" runat="server" Text='<%# Eval("U_Z_NoOfHours") %>'></asp:Label></div>
                                                                                        </ItemTemplate>
                                                                                    </asp:TemplateField>
                                                                                    <asp:TemplateField HeaderText="Start Time">
                                                                                        <ItemTemplate>
                                                                                            <div align="left">
                                                                                                &nbsp;<asp:Label ID="lblTstarttime" runat="server" Text='<%# Eval("U_Z_StartTime") %>'></asp:Label></div>
                                                                                        </ItemTemplate>
                                                                                    </asp:TemplateField>
                                                                                    <asp:TemplateField HeaderText="End Time">
                                                                                        <ItemTemplate>
                                                                                            <div align="left">
                                                                                                &nbsp;<asp:Label ID="lblTendtime" runat="server" Text='<%# Eval("U_Z_EndTime") %>'></asp:Label></div>
                                                                                        </ItemTemplate>
                                                                                    </asp:TemplateField>
                                                                                    <asp:TemplateField HeaderText="Attendees Cost" Visible="false">
                                                                                        <ItemTemplate>
                                                                                            <div align="left">
                                                                                                &nbsp;<asp:Label ID="lblTAttCost" runat="server" Text='<%# Eval("U_Z_AttCost") %>'></asp:Label></div>
                                                                                        </ItemTemplate>
                                                                                    </asp:TemplateField>
                                                                                    <asp:TemplateField HeaderText="Sunday" Visible="false">
                                                                                        <ItemTemplate>
                                                                                            <div align="left">
                                                                                                &nbsp;<asp:Label ID="lblsunday" runat="server" Text='<%#Bind("U_Z_Sunday") %>'></asp:Label></div>
                                                                                        </ItemTemplate>
                                                                                    </asp:TemplateField>
                                                                                    <asp:TemplateField HeaderText="Monday" Visible="false">
                                                                                        <ItemTemplate>
                                                                                            <div align="left">
                                                                                                &nbsp;<asp:Label ID="lblMonday" runat="server" Text='<%# Eval("U_Z_Monday") %>'></asp:Label></div>
                                                                                        </ItemTemplate>
                                                                                    </asp:TemplateField>
                                                                                    <asp:TemplateField HeaderText="Tuesday" Visible="false">
                                                                                        <ItemTemplate>
                                                                                            <div align="left">
                                                                                                &nbsp;<asp:Label ID="lblTuesday" runat="server" Text='<%# Eval("U_Z_Tuesday") %>'></asp:Label></div>
                                                                                        </ItemTemplate>
                                                                                    </asp:TemplateField>
                                                                                    <asp:TemplateField HeaderText="Wednesday" Visible="false">
                                                                                        <ItemTemplate>
                                                                                            <div align="left">
                                                                                                &nbsp;<asp:Label ID="lblWednesday" runat="server" Text='<%# Eval("U_Z_Wednesday") %>'></asp:Label></div>
                                                                                        </ItemTemplate>
                                                                                    </asp:TemplateField>
                                                                                    <asp:TemplateField HeaderText="Thursday" Visible="false">
                                                                                        <ItemTemplate>
                                                                                            <div align="left">
                                                                                                &nbsp;<asp:Label ID="lblThursday" runat="server" Text='<%# Eval("U_Z_Thursday") %>'></asp:Label></div>
                                                                                        </ItemTemplate>
                                                                                    </asp:TemplateField>
                                                                                    <asp:TemplateField HeaderText="Friday" Visible="false">
                                                                                        <ItemTemplate>
                                                                                            <div align="left">
                                                                                                &nbsp;<asp:Label ID="lblFriday" runat="server" Text='<%# Eval("U_Z_Friday") %>'></asp:Label></div>
                                                                                        </ItemTemplate>
                                                                                    </asp:TemplateField>
                                                                                    <asp:TemplateField HeaderText="Saturday" Visible="false">
                                                                                        <ItemTemplate>
                                                                                            <div align="left">
                                                                                                &nbsp;<asp:Label ID="lblSaturday" runat="server" Text='<%# Eval("U_Z_Saturday") %>'></asp:Label></div>
                                                                                        </ItemTemplate>
                                                                                    </asp:TemplateField>
                                                                                    <asp:TemplateField HeaderText="Active" Visible="false">
                                                                                        <ItemTemplate>
                                                                                            <div align="left">
                                                                                                &nbsp;<asp:Label ID="lblactive" runat="server" Text='<%# Eval("U_Z_Active") %>'></asp:Label></div>
                                                                                        </ItemTemplate>
                                                                                    </asp:TemplateField>
                                                                                </Columns>
                                                                                <HeaderStyle HorizontalAlign="Center" Height="25px" BackColor="#CCCCCC" />
                                                        ...
                                                        <ajx:TabPanel ID="TabPanel5" runat="server" HeaderText="Activity Notification">
                                                            <ContentTemplate>
                                                                <table width="100%" border="0" cellspacing="0" cellpadding="3" class="main_content">
                                                                    <tr>
                                                                        <td style="padding-top: 10px;">
                                                                            <asp:GridView ID="grdActivity" runat="server" CellPadding="4" AllowPaging="True"
                                                                                ...
                                                                                <Columns>
                                                                                    <asp:TemplateField HeaderText="Request Code">
                                                                                        <ItemTemplate>
                                                                                            <div align="center">
                                                                                                <asp:Label ID="lbtndocnum" runat="server" Text='<%#Bind("clgCode") %>'></asp:Label></div>
                                                                                        </ItemTemplate>
                                                                                    </asp:TemplateField>
                                                                                    <asp:TemplateField HeaderText="Employee ID">
                                                                                        <ItemTemplate>
                                                                                            <div align="center">
                                                                                                <asp:Label ID="lblempid" runat="server" Text='<%#Bind("U_Z_HREmpID") %>'></asp:Label></div>
                                                                                        </ItemTemplate>
                                                                                    </asp:TemplateField>
                                                                                    <asp:TemplateField HeaderText="Employee Name">
                                                                                        <ItemTemplate>
                                                                                            <div align="center">
                                                                                                <asp:Label ID="lblempname" runat="server" Text='<%#Bind("U_Z_HREmpName") %>'></asp:Label></div>
                                                                                        </ItemTemplate>
                                                                                    </asp:TemplateField>
                                                                                    ...
                                                                                    <asp:TemplateField HeaderText="Activity Subject">
                                                                                        <ItemTemplate>
                                                                                            <div align="center">
                                                        ...
                                                        <ajx:TabPanel ID="TabPanel7" runat="server" HeaderText="Employee Leave Balance">
                                                            <ContentTemplate>
                                                                <table width="100%" border="0" cellspacing="0" cellpadding="3" class="main_content">
                                                                    <tr>
                                                                        <td style="padding-top: 10px;">
                                                                            <asp:GridView ID="grdLeaveBal" runat="server" CellPadding="4" ShowHeaderWhenEmpty="true"
                                                                                EmptyDataText="No records Found" CssClass="mGrid" HeaderStyle-CssClass="GridBG"
                                                                                AllowPaging="True" AutoGenerateColumns="False" Width="100%" PageSize="10">
                                                                                <Columns>
                                                                                    <asp:TemplateField HeaderText="Year">
                                                                                        <ItemTemplate>
                                                                                            <div align="center">
                                                                                                <asp:Label ID="lblyear" runat="server" Text='<%#Bind("U_Z_Year") %>'></asp:Label></div>
                                                                                        </ItemTemplate>
                                                                                    </asp:TemplateField>
                                                                                    <asp:TemplateField HeaderText="Leave Code">
                                                                                        <ItemTemplate>
                                                                                            <div align="center">
                                                                                                <asp:Label ID="lbllvecode" runat="server" Text='<%#Bind("U_Z_LeaveCode") %>'></asp:Label></div>
                                                                                        </ItemTemplate>
                                                                                    </asp:TemplateField>
                                                                                    <asp:TemplateField HeaderText="Leave Name">
                                                                                        <ItemTemplate>
                                                                                            <div align="left">
                                                                                                &nbsp;<asp:Label ID="lbllvename" runat="server" Text='<%#Bind("U_Z_LeaveName") %>'></asp:Label></div>
                                                                                        </ItemTemplate>
                                                                                    </asp:TemplateField>
                                                                                    <asp:TemplateField HeaderText="Yearly Entitlement">
                                                                                        <ItemTemplate>
                                                                                            <div align="left">
                                                                                                &nbsp;<asp:Label ID="lblEntitle" runat="server" Text='<%#Bind("U_Z_Entile") %>'></asp:Label></div>
                                                                                        </ItemTemplate>
                                                                                    </asp:TemplateField>
                                                                                    <asp:TemplateField HeaderText="Carried Over Balance">
                                                                                        <ItemTemplate>
                                                                                            <div align="left">
                                                                                                &nbsp;<asp:Label ID="lblcob" runat="server" Text='<%#Bind("U_Z_CAFWD") %>'></asp:Label></div>
                                                                                        </ItemTemplate>
                                                                                    </asp:TemplateField>
                                                                                    <asp:TemplateField HeaderText="Carried Over Balance Amount">
                                                                                        <ItemTemplate>
                                                                                            <div align="left">
                                                                                                &nbsp;<asp:Label ID="lblcarried" runat="server" Text='<%#Bind("U_Z_CAFWDAMT") %>'></asp:Label></div>
                                                                                        </ItemTemplate>
                                                                                    </asp:TemplateField>
                                                                                    <asp:TemplateField HeaderText="Accured Balance">
                                                                                        <ItemTemplate>
                                                                                            <div align="center">
                                                                                                &nbsp;<asp:Label ID="lblAccbal" runat="server" Text='<%#Bind("U_Z_ACCR") %>'></asp:Label></div>
                                                                                        </ItemTemplate>
                                                                                    </asp:TemplateField>
                                                                                    <asp:TemplateField HeaderText="Availed Days">
                                                                                        <ItemTemplate>
                                                                                            <div align="center">
                                                                                                &nbsp;<asp:Label ID="lblAvaildays" runat="server" Text='<%#Bind("U_Z_Trans") %>'></asp:Label></div>
                                                                                        </ItemTemplate>
                                                                                    </asp:TemplateField>
                                                                                    <asp:TemplateField HeaderText="Adjustment Days">
                                                                                        <ItemTemplate>
                                                                                            <div align="left">
                                                                                                &nbsp;<asp:Label ID="lblAdjuDays" runat="server" Text='<%#Bind("U_Z_Adjustment") %>'></asp:Label></div>
                                                                                        </ItemTemplate>
                                                                                    </asp:TemplateField>
                                                                                    <asp:TemplateField HeaderText="Current Balance">
                                                                                        <ItemTemplate>
                                                                                            <div align="left">
                                                                                                &nbsp;<asp:Label ID="lblbalance" runat="server" Text='<%#Bind("U_Z_Balance") %>'></asp:Label></div>
                                                                                        </ItemTemplate>
                                                                                    </asp:TemplateField>
                                                                                    <asp:TemplateField HeaderText="Closing Balance Amount">
                                                                                        <ItemTemplate>
                                                                                            <div align="center">
                                                                                                &nbsp;<asp:Label ID="lblclosing" runat="server" Text='<%#Bind("U_Z_BalanceAmt") %>'></asp:Label></div>
                                                                                        </ItemTemplate>
                                                                                    </asp:TemplateField>
                                                                                    <asp:TemplateField HeaderText="OB">
                                                                                        <ItemTemplate>
                                                                                            <div align="center">
                                                                                                &nbsp;<asp:Label ID="lblOB" runat="server" Text='<%#Bind("U_Z_OB") %>'></asp:Label></div>
                                                                                        </ItemTemplate>
                                                                                    </asp:TemplateField>
                                                                                    <asp:TemplateField HeaderText="EnCashment Days">
                                                                                        <ItemTemplate>
                                                                                            <div align="center">
                                                                                                &nbsp;<asp:Label ID="lblEncash" runat="server" Text='<%#Bind("U_Z_EnCash") %>'></asp:Label></div>
                                                                                        </ItemTemplate>
                                                                                    </asp:TemplateField>
                ...
                <tr>
                    <td>
                        ...
                        <asp:Panel ID="Panelpoptechnician" runat="server" BackColor="White" Style="display: none;
                            ...
                            <div>
                                <span class="sideheading" style="color: Green;">Approval required for the following requests</span>
                                <span style="float: right;">
                                    <asp:Button ID="btnclstech" runat="server" CssClass="btn" Width="30px" Text="X" /></span></div>
                            <br />
                            <br />
                            <asp:Panel ID="Panel4" runat="server" Height="400px" Width="300px">
                                <table width="100%" border="0" cellspacing="0" cellpadding="3" class="main_content">
                                    <tr>
                                        <td>
                                        ...
                                        <td>
                                            <asp:Label ID="lblregtrain"  runat="server"></asp:Label>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                        ...
                                        <td>
                                            <asp:Label ID="lblNewTrain"  runat="server"></asp:Label>
                                        </td>
                                    </tr>
                                     <tr>
                                        <td>
                                        ...
                                        <td>
                                            <asp:Label ID="lblempPro"  runat="server"></asp:Label>
                                        </td>
                                    </tr>
                                     <tr>
                                        <td>
                                            4.Employee Position Change
                                        </td>
                                        <td>
                                            <asp:Label ID="lblempPosChange"  runat="server"></asp:Label>
                                        </td>
                                    </tr>
                                     <tr>
                                        <td>
                                        ...
                                        <td>
                                            <asp:Label ID="lbltramgnt"  runat="server"></asp:Label>
                                        </td>
                                    </tr>
                                      <tr>
                                        <td>
                                        ...
                                        <td>
                                            <asp:Label ID="lblexpClaim"  runat="server"></asp:Label>
                                        </td>
                                    </tr>
                                      <tr>
                                        <td>
                                      ...
                                      <tr>
                                        ...
                                        <td>
                                            <asp:Label ID="lblcanshort"  runat="server"></asp:Label>
                                        </td>
                                    </tr>
                                      <tr>
                                        <td>
                                      ...
                                      <tr>
                                        ...
                                        <td>
                                            <asp:Label ID="lblretLeave"  runat="server"></asp:Label>
                                        </td>
                                    </tr>
                                      <tr>
                                        <td>
