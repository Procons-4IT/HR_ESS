<%@ Page Title="LeaveRequest Approval" Language="vb" AutoEventWireup="false" MasterPageFile="~/HRMS.Master"
    CodeBehind="LeaveRequestApproval.aspx.vb" Inherits="HRMS.LeaveRequestApproval" %>
            ...
            <table width="99%" border="0" cellspacing="0" cellpadding="4" class="main_content">
                <tr>
                    <td height="30" align="left" colspan="2" valign="bottom" background="images/h_bg.png"
                        ...
                        <div>
                            &nbsp;
                            <asp:Label ID="Label3" runat="server" Text="Leave Request Approval" CssClass="subheader"
                                            ...
                                            <tr>
                                                <td valign="top">
                                                    <ajx:TabContainer ID="TabContainer2" runat="server" ActiveTabIndex="0" CssClass="ajax__tab_yuitabview-theme"
                                                        Width="100%">
                                                        <ajx:TabPanel ID="TabPanel3" runat="server" HeaderText="Leave Request Approval">
                                                            <ContentTemplate>
                                                                                ...
                                                                                <asp:GridView ID="grdRequestApproval" runat="server" CellPadding="4" AllowPaging="True"
                                                                                    ...
                                                                                    <Columns>
                                                                                        ...
                                                                                        <asp:TemplateField HeaderText="T&A Emp.ID">
                                                                                            <ItemTemplate>
                                                                                                <div align="center">
                                                                                                    <asp:Label ID="lbltaEmpid" runat="server" Text='<%#Bind("TAEmpID") %>'></asp:Label></div>
                                                                                            </ItemTemplate>
                                                                                        </asp:TemplateField>
                                                                                        ...
                                                                                        <asp:TemplateField HeaderText="Leave Name">
                                                                                            <ItemTemplate>
                                                                                                <div align="left">
                                                                                                    &#160;<asp:Label ID="lbllveName" runat="server" Text='<%#Bind("U_Z_LeaveName") %>'
                                                                                                        Width="130px"></asp:Label></div>
                                                                                            </ItemTemplate>
                                                                                        </asp:TemplateField>
                                                                                        <asp:TemplateField HeaderText="Leave Type" Visible="false">
                                                                                            <ItemTemplate>
                                                                                                <div align="left">
                                                                                                    &#160;<asp:Label ID="lblAgenda" runat="server" Text='<%#Bind("U_Z_TrnsCode") %>'></asp:Label></div>
                                                                                            </ItemTemplate>
                                                                                        </asp:TemplateField>
                                                                                        <asp:TemplateField HeaderText="From Date">
                                                                                            <ItemTemplate>
                                                                                                <div align="left">
                                                                                                    &#160;<asp:Label ID="lblCouCode" runat="server" Text='<%#Bind("U_Z_StartDate") %>'></asp:Label></div>
                                                                                            </ItemTemplate>
                                                                                        </asp:TemplateField>
                                                                                        <asp:TemplateField HeaderText="To Date">
                                                                                            <ItemTemplate>
                                                                                                <div align="left">
                                                                                                    &#160;<asp:Label ID="lblCouName" runat="server" Text='<%#Bind("U_Z_EndDate") %>'></asp:Label></div>
                                                                                            </ItemTemplate>
                                                                                        </asp:TemplateField>
                                                                                        <asp:TemplateField HeaderText="No.of Days">
                                                                                            <ItemTemplate>
                                                                                                <div align="left">
                                                                                                    &#160;<asp:Label ID="lblCouType" runat="server" Text='<%#Bind("U_Z_NoofDays") %>'></asp:Label></div>
                                                                                            </ItemTemplate>
                                                                                        </asp:TemplateField>
                                                                                        <asp:TemplateField HeaderText="Remarks">
                                                                                            <ItemTemplate>
                                                                                                <div align="left">
                                                                                                    &#160;<asp:Label ID="lblstdate" runat="server" Text='<%#Bind("U_Z_Notes") %>'></asp:Label></div>
                                                                                            </ItemTemplate>
                                                                                        </asp:TemplateField>
                                                                                        <asp:TemplateField HeaderText="Payroll Month">
                                                                                            <ItemTemplate>
                                                                                                <div align="left">
                                                                                                    &#160;<asp:Label ID="lblpaymonth" runat="server" Text='<%#Bind("U_Z_Month") %>'></asp:Label></div>
                                                                                            </ItemTemplate>
                                                                                        </asp:TemplateField>
                                                                                        <asp:TemplateField HeaderText="Payroll Year">
                                                                                            <ItemTemplate>
                                                                                                <div align="left">
                                                                                                    &#160;<asp:Label ID="lblpayyear" runat="server" Text='<%#Bind("U_Z_Year") %>'></asp:Label></div>
                                                                                            </ItemTemplate>
                                                                                        </asp:TemplateField>
                                                                                        <asp:TemplateField HeaderText="Approval Status">
                                                                                            <ItemTemplate>
                                                                                                <div align="left">
                                                                                                    &#160;<asp:Label ID="lblAppStatus" runat="server" Text='<%#Bind("U_Z_Status") %>'></asp:Label></div>
                                                                                            </ItemTemplate>
                                                                                        </asp:TemplateField>
                                                                                        ...
                                                                                        <asp:TemplateField HeaderText="LeaveBalance">
                                                                                            <ItemTemplate>
                                                                                                <div align="left">
                                                                                                    &nbsp;<asp:LinkButton ID="lbtnactivity" runat="server" Text="View" OnClick="lbtnactivity_Click"></asp:LinkButton></div>
                                                                                            </ItemTemplate>
                                                                                        </asp:TemplateField>
                                                                                        <asp:TemplateField HeaderText="Approved Leave Transactions">
                                                                                            <ItemTemplate>
                                                                                                <div align="left">
                                                                                                    &nbsp;<asp:LinkButton ID="lbtnHistory" runat="server" Text="View" OnClick="lbtnHistory_Click"></asp:LinkButton></div>
                                                                                            </ItemTemplate>
                                                                                        </asp:TemplateField>
                                                                                    </Columns>
                                                                            ...
                                                                            <asp:GridView ID="grdSummary" runat="server" CellPadding="4" AllowPaging="True" ShowHeaderWhenEmpty="true"
                                                                                ...
                                                                                <Columns>
                                                                                    ...
                                                                                    <asp:TemplateField HeaderText="T&A Emp.ID">
                                                                                        <ItemTemplate>
                                                                                            <div align="center">
                                                                                                <asp:Label ID="lblStaEmpid" runat="server" Text='<%#Bind("TAEmpID") %>'></asp:Label></div>
                                                                                        </ItemTemplate>
                                                                                    </asp:TemplateField>
                                                                                    <asp:TemplateField HeaderText="Emp.Code">
                                                                                        <ItemTemplate>
                                                                                    ...
                                                                                    <asp:TemplateField HeaderText="Leave Type" Visible="false">
                                                                                        <ItemTemplate>
                                                                                            <div align="left">
                                                                                                &#160;<asp:Label ID="lblsAgenda" runat="server" Text='<%#Bind("U_Z_TrnsCode") %>'></asp:Label></div>
                                                                                        </ItemTemplate>
                                                                                    </asp:TemplateField>
                                                                                    <asp:TemplateField HeaderText="From Date">
                                                                                        <ItemTemplate>
                                                                                            <div align="left">
                                                                                                &#160;<asp:Label ID="lblsCouCode" runat="server" Text='<%#Bind("U_Z_StartDate") %>'></asp:Label></div>
                                                                                        </ItemTemplate>
                                                                                    </asp:TemplateField>
                                                                                    <asp:TemplateField HeaderText="To Date">
                                                                                        <ItemTemplate>
                                                                                            <div align="left">
                                                                                                &#160;<asp:Label ID="lblsCouName" runat="server" Text='<%#Bind("U_Z_EndDate") %>'></asp:Label></div>
                                                                                        </ItemTemplate>
                                                                                    </asp:TemplateField>
                                                                                    <asp:TemplateField HeaderText="No.of Days">
                                                                                        <ItemTemplate>
                                                                                            <div align="left">
                                                                                                &#160;<asp:Label ID="lblsCouType" runat="server" Text='<%#Bind("U_Z_NoofDays") %>'></asp:Label></div>
                                                                                        </ItemTemplate>
                                                                                    </asp:TemplateField>
                                                                                    <asp:TemplateField HeaderText="Remarks">
                                                                                        <ItemTemplate>
                                                                                            <div align="left">
                                                                                                &#160;<asp:Label ID="lblsstdate" runat="server" Text='<%#Bind("U_Z_Notes") %>'></asp:Label></div>
                                                                                        </ItemTemplate>
                                                                                    </asp:TemplateField>
                                                                                    <asp:TemplateField HeaderText="Payroll Month">
                                                                                        <ItemTemplate>
                                                                                            <div align="left">
                                                                                                &#160;<asp:Label ID="lblspaymonth" runat="server" Text='<%#Bind("U_Z_Month") %>'></asp:Label></div>
                                                                                        </ItemTemplate>
                                                                                    </asp:TemplateField>
                                                                                    <asp:TemplateField HeaderText="Payroll Year">
                                                                                        <ItemTemplate>
                                                                                            <div align="left">
                                                                                                &#160;<asp:Label ID="lblspayyear" runat="server" Text='<%#Bind("U_Z_Year") %>'></asp:Label></div>
                                                                                        </ItemTemplate>
                                                                                    </asp:TemplateField>
                                                                                    <asp:TemplateField HeaderText="Approval Status">
                                                                                        <ItemTemplate>
                ...
                <tr>
                    <td>
                        <asp:Panel ID="Panelpoptechnician" runat="server" BackColor="White" Style="display: none;
                            ...
                            <div>
                                <span class="sideheading" style="color: Green;">Leave Balance Details</span> <span
                                    style="float: right;">
