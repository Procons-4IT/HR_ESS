<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/ESS/ESSMaster.Master"
    CodeBehind="RetrunLevReq.aspx.vb" Inherits="HRMS.RetrunLevReq" %>
            ...
            <table width="99%" border="0" cellspacing="0" cellpadding="4" class="main_content">
                ...
                <tr>
                    <td height="30" align="left" colspan="2" valign="bottom" background="images/h_bg.png"
                        ...
                        <div>
                            &nbsp;
                            <asp:Label ID="Label3" runat="server" Text="Return From Leave Request" CssClass="subheader"
                                                                    ...
                                                                    <tr>
                                                                        <td>
                                                                            <asp:GridView ID="grdLeaveRequest" runat="server" CellPadding="4" AllowPaging="True"
                                                                                ShowHeaderWhenEmpty="true" CssClass="mGrid" EmptyDataText="No records Found"
                                                                                ...
                                                                                <Columns>
                                                                                    ...
                                                                                    <asp:TemplateField HeaderText="Request Status" Visible="false">
                                                                                        <ItemTemplate>
                                                                                            <div align="left">
                                                                                                &nbsp;<asp:Label ID="lblRestatus" runat="server" Text='<%#Bind("U_Z_Status") %>'></asp:Label></div>
                                                                                        </ItemTemplate>
                                                                                    </asp:TemplateField>
                                                                                    <asp:TemplateField HeaderText="Return Approval Status">
                                                                                        <ItemTemplate>
                                                                                            <div align="left">
                                                                                                &nbsp;<asp:Label ID="lblstatus" runat="server" Text='<%#Bind("U_Z_RStatus") %>'></asp:Label></div>
                                                                                        </ItemTemplate>
                                                                                    </asp:TemplateField>
                                                                                    <asp:TemplateField HeaderText="Approver Remarks">
                                                                                        <ItemTemplate>
                                                                                            <div align="left">
                                                                                                &nbsp;<asp:Label ID="lblAppRemark" runat="server" Text='<%#Bind("U_Z_RAppRemarks") %>'></asp:Label></div>
                                                                                        </ItemTemplate>
                                                                                    </asp:TemplateField>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <ajx:CalendarExtender ID="CalendarExtender4" Animated="true" Format="dd/MM/yyyy"
                                                        runat="server" TargetControlID="txtretrejoin" CssClass="cal_Theme1">
                                                    </ajx:CalendarExtender>
                                                </td>
                                            </tr>
                                            <tr>
