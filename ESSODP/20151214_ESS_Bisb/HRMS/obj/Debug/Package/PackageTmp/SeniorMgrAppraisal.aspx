                            ...
                            <Columns>
                                ...
                                <div align="right"><asp:Label ID="lblBselfrate" runat="server" ></asp:Label>&nbsp;</div>
                                 ...
                                 <asp:TemplateField HeaderText="First Level Manager Remarks">
                                    <ItemTemplate>
                                          <div align="left">&nbsp;
                                              <asp:Label ID="lblBstmgremark" runat="server" Text='<%#Bind("U_Z_MgrRemark") %>' CssClass="txtbox" Width="100"></asp:Label>
                                          </div>
                                    </ItemTemplate>                                                                       
                                </asp:TemplateField>
                                ...
                                <asp:TemplateField HeaderText="Second Level Manager Rating">
                                  ...
                                  <asp:TemplateField HeaderText="Second Level Manager Remarks">
                                    <ItemTemplate>
                                          <div align="left">&nbsp;
                                              <asp:TextBox ID="txtBfstmgrRemarks" runat="server" Text='<%#Bind("U_Z_SrRemark") %>' CssClass="txtbox" Width="100"></asp:TextBox>
                                          </div>
                                    </ItemTemplate>                                                                       
                                </asp:TemplateField>
                            ...
                            <Columns>
                                ...
                                <div align="right"><asp:Label ID="lblPselfrate" runat="server" ></asp:Label>&nbsp;</div>
                                 ...
                                 <asp:TemplateField HeaderText="First Level Manager Remarks">
                                    <ItemTemplate>
                                          <div align="left">&nbsp;
                                              <asp:Label ID="lblPSecoMgrRemark" runat="server" Text='<%#Bind("U_Z_MgrRemark") %>' CssClass="txtbox" ></asp:Label>
                                          </div>
                                    </ItemTemplate>                                                                       
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="Line Manager Rating" visible="false" >
                                 ...
                                 <asp:TemplateField HeaderText="Second Level Manager Rating">
                                    <ItemTemplate>                                       
                                        <div align="left">&nbsp;<asp:DropDownList ID="ddlsmgrrate" runat="server" autopostback="true" OnSelectedIndexChanged="ddlpesmgrfrate_SelectedIndexChanged" EnableViewState="true"></asp:DropDownList></div>
                                    </ItemTemplate>                                                                       
                                </asp:TemplateField>
                                 <asp:TemplateField HeaderText="Second Level Manager Remarks">
                                    <ItemTemplate>
                                          <div align="left">&nbsp;
                                              <asp:TextBox ID="txtPfstmgrRemarks" runat="server" Text='<%#Bind("U_Z_SrRemark") %>' CssClass="txtbox" Width="100"></asp:TextBox>
                                          </div>
                                    </ItemTemplate>                                                                       
                                </asp:TemplateField>
                                  <asp:TemplateField HeaderText="Senior Manager Rating" visible="false" >
                                ...
                                <asp:TemplateField HeaderText="Competences Description">
                                 ...
                                 <asp:TemplateField HeaderText="First Level Manager Rating">
                                  ...
                                  <asp:TemplateField HeaderText="First Level Manager Remarks">
                                    <ItemTemplate>
                                          <div align="left">&nbsp;
                                              <asp:Label ID="lblCSecoMgrRemark" runat="server" Text='<%#Bind("U_Z_MgrRemark") %>' CssClass="txtbox" ></asp:Label>
                                          </div>
                                    </ItemTemplate>                                                                       
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="Line Manager Rating" visible="false" >
                                  ...
                                  <asp:TemplateField HeaderText="Second Level Manager Rating">
                                    <ItemTemplate>                                       
                                        <div align="left">&nbsp;<asp:DropDownList ID="ddlcompsmgrrate" runat="server" autopostback="true" OnSelectedIndexChanged="ddlCompsmgrfrate_SelectedIndexChanged" EnableViewState="true" ></asp:DropDownList></div>
                                    </ItemTemplate>                                                                       
                                </asp:TemplateField>
                                 <asp:TemplateField HeaderText="Second Level Manager Remarks">
                                    <ItemTemplate>
                                          <div align="left">&nbsp;
                                              <asp:TextBox ID="txtCfstmgrRemarks" runat="server" Text='<%#Bind("U_Z_SrRemark") %>' CssClass="txtbox" Width="100"></asp:TextBox>
                                          </div>
                                    </ItemTemplate>                                                                       
                                </asp:TemplateField>
                                   <asp:TemplateField HeaderText="Senior Manager Rating" visible="false" >
