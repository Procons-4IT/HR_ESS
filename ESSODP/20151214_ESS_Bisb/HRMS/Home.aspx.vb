...
Public Class Home
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        If Not Page.IsPostBack Then
            ...
            Else
                ...
                objEN.UserCode = objHDA.GetUserCode(objEN)
                PendingApproval(objEN)
    ...
    End Sub
    Private Sub PendingApproval(ByVal objEN As HomeEN)
        Try
            dbCon.dss5 = objHDA.PendingApproval(objEN)
            If dbCon.dss5.Tables(0).Rows.Count <> 0 Then
                lblregtrain.Text = dbCon.dss5.Tables(0).Rows(0)(0).ToString()
                lblNewTrain.Text = dbCon.dss5.Tables(1).Rows(0)(0).ToString()
                lblempPro.Text = dbCon.dss5.Tables(2).Rows(0)(0).ToString()
                lblempPosChange.Text = dbCon.dss5.Tables(3).Rows(0)(0).ToString()
                lbltramgnt.Text = dbCon.dss5.Tables(4).Rows(0)(0).ToString()
                lblexpClaim.Text = dbCon.dss5.Tables(5).Rows(0)(0).ToString()
                lblRec.Text = dbCon.dss5.Tables(6).Rows(0)(0).ToString()
                lblcanshort.Text = dbCon.dss5.Tables(7).Rows(0)(0).ToString()
                lblinternal.Text = dbCon.dss5.Tables(8).Rows(0)(0).ToString()
                lblpersonal.Text = dbCon.dss5.Tables(9).Rows(0)(0).ToString()
                lblLoan.Text = dbCon.dss5.Tables(10).Rows(0)(0).ToString()

                lblleave.Text = dbCon.dss5.Tables(11).Rows(0)(0).ToString()
                lblretLeave.Text = dbCon.dss5.Tables(12).Rows(0)(0).ToString()
                lblbank.Text = dbCon.dss5.Tables(13).Rows(0)(0).ToString()
            End If
    ...
    Private Sub PopulateEmployee(ByVal objEN As HomeEN)
        ...
        If dbCon.dss.Tables(0).Rows.Count > 0 Then
            ...
            If dbCon.dss.Tables(0).Rows(0)("position").ToString() <> "" Then
                txtposition.Text = dbCon.dss.Tables(0).Rows(0)("position").ToString()
                txtposname.Text = dbCon.dss.Tables(0).Rows(0)("Positionname").ToString()
                lblposName.Text = dbCon.dss.Tables(0).Rows(0)("Positionname").ToString()
            End If
            If dbCon.dss.Tables(0).Rows(0)("dept").ToString() <> "" Then
                txtdept.Text = dbCon.dss.Tables(0).Rows(0)("dept").ToString()
                txtdeptname.Text = dbCon.dss.Tables(0).Rows(0)("Deptname").ToString()
                lbldeptName.Text = dbCon.dss.Tables(0).Rows(0)("Deptname").ToString()
            End If
            ...
            lblgrade.Text = dbCon.dss.Tables(0).Rows(0)("U_Z_GrdName").ToString()
            lblSalScale.Text = dbCon.dss.Tables(0).Rows(0)("U_Z_HR_SalaryCode").ToString()
            If dbCon.dss.Tables(0).Rows(0)("Manager").ToString() <> "" Then
                objEN.Manager = dbCon.dss.Tables(0).Rows(0)("Manager").ToString()
