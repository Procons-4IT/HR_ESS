...
Public Class EmpPaySlip
    ...
    Public Sub ExportPDF()
        Try
            ...
            Dim str As String = System.AppDomain.CurrentDomain.BaseDirectory
            Dim strLoc As String = DateTime.Now.ToString("yyyyMMddHHmmss").ToString() 'str + objen.EmpCode + "_" + ddlMonth.SelectedItem.Text + ".pdf"
    ...
    'Private Sub EmpPaySlip_Unload(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Unload
