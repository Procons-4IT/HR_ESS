<%@ Page Title="New Training Request" Language="vb" AutoEventWireup="false" MasterPageFile="~/ESS/ESSMaster.Master"
    CodeBehind="ENewTrainingReq.aspx.vb" Inherits="HRMS.ENewTrainingReq" %>
                                    ...
                                    <asp:Panel ID="PanelNewRequest" runat="server" Width="100%" BorderColor="LightSteelBlue"
                                        ...
                                        <table width="100%" border="0" cellspacing="0" cellpadding="3" class="main_content">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <asp:TextBox ID="txtcost" CssClass="txtbox" runat="server" onkeypress="AllowNumbers(this);checkDec1(this);RemoveZero(this);"
                                                        onkeyup="AllowNumbers(this);checkDec1(this);RemoveZero(this);"></asp:TextBox>
                                                </td>
                                                <td>
                                                    Est.Travel and Living Expenses
                                                </td>
                                                <td>
                                                    <asp:TextBox ID="txtestexp" CssClass="txtbox" runat="server" onkeypress="AllowNumbers(this);checkDec1(this);RemoveZero(this);"
                                                        onkeyup="AllowNumbers(this);checkDec1(this);RemoveZero(this);"></asp:TextBox>
                                                </td>
                                            </tr>
                                            <tr>
