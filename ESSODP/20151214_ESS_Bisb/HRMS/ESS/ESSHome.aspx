<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/ESS/ESSMaster.Master"
    CodeBehind="ESSHome.aspx.vb" Inherits="HRMS.ESSHome" %>
                 ...
                 <td>
                  ...
                  <td width="30%">
                   <asp:Label ID="txtpager"  CssClass="txtbox" Width="150px" runat="server"></asp:Label>        
                                                        ...
                                                        <ajx:TabPanel ID="TabPanel5" runat="server" HeaderText="Employee Leave Balance">
                                                            <ContentTemplate>
                                                                <table width="100%" border="0" cellspacing="0" cellpadding="3" class="main_content">
                                                                    <tr>
                                                                        <td style="padding-top: 10px;">
