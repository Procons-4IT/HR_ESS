<%@ Page Title="Request to HR" Language="vb" AutoEventWireup="false" MasterPageFile="~/ESS/ESSMaster.Master"
    CodeBehind="EmpReqtoHR.aspx.vb" Inherits="HRMS.EmpReqtoHR" %>
            ...
            <table width="99%" border="0" cellspacing="0" cellpadding="4" class="main_content">
                <tr>
                    <td height="30" align="left" colspan="2" valign="bottom" background="../images/h_bg.png"
                        ...
                        <div>
                            &nbsp;
                            <asp:Label ID="Label3" runat="server" Text="Request to HR" CssClass="subheader" Style="float: left;"></asp:Label>
                            <span>
                                            ...
                                            <tr>
                                                <td valign="top">
                                                    <ajx:TabContainer ID="TabContainer2" runat="server" ActiveTabIndex="0" CssClass="ajax__tab_yuitabview-theme"
                                                        Width="100%">
                                                        <ajx:TabPanel ID="TabPanel3" runat="server" HeaderText="Employee Request to HR">
                                                            <ContentTemplate>
                                        ...
                                        <div id="Div1" runat="server" class="DivCorner" style="border: solid 2px LightSteelBlue;
                                            ...
                                            <table width="99%" border="0" cellspacing="0" cellpadding="4" class="main_content">
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="style1">
                                                        <asp:DropDownList ID="ddlActivity" CssClass="txtbox1" Width="150px" runat="server"
                                                            Enabled="false">
                                                                ...
                                                                <table width="100%" border="0" cellspacing="0" cellpadding="3" class="main_content">
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            ...
                                                                            <asp:Label
                                                                                ID="lbldurtype" runat="server" Visible="false"></asp:Label>
                                                                        </td>
                                                                        <td width="15%">
                                                                        </td>
                                                                    </tr>
                                                                      <tr>
                                                                        ...
                                                                        <td>
                                                                            <asp:DropDownList ID="ddlStatus" CssClass="txtbox1" Width="150px" runat="server" Visible="false">
                                                                            </asp:DropDownList>
                                                                        </td>
                                                                        <td width="15%">
                                                                        </td>
