<%@ Page Title="Leave Request" Language="vb" AutoEventWireup="false" MasterPageFile="~/ESS/ESSMaster.Master"
    CodeBehind="LeaveReq.aspx.vb" Inherits="HRMS.LeaveReq" %>
            ...
            <table width="99%" border="0" cellspacing="0" cellpadding="4" class="main_content">
                ...
                <tr>
                    <td height="30" align="left" colspan="2" valign="bottom" background="images/h_bg.png"
                        ...
                        <div>
                            &nbsp;
                            <asp:Label ID="Label3" runat="server" Text="Leave Request" CssClass="subheader" Style="float: left;"></asp:Label>
                            <span>
                                            ...
                                            <tr>
                                                <td valign="top">
                                                    <ajx:TabContainer ID="TabContainer2" runat="server" ActiveTabIndex="0" CssClass="ajax__tab_yuitabview-theme"
                                                        Width="100%">
                                                        <ajx:TabPanel ID="TabPanel3" runat="server" HeaderText="Leave Request">
                                                            <ContentTemplate>
                                                                            ...
                                                                            <asp:GridView ID="grdLeaveRequest" runat="server" CellPadding="4" AllowPaging="True"
                                                                                ...
                                                                                <Columns>
                                                                                    ...
                                                                                    <asp:TemplateField HeaderText="Leave Type">
                                                                                        <ItemTemplate>
                                                                                            <div align="center">
                                                                                                <asp:Label ID="lbllvetype" runat="server" Text='<%#Bind("Name") %>'></asp:Label></div>
                                                                                        </ItemTemplate>
                                                                                    </asp:TemplateField>
                                                                                    ...
                                                                                    <asp:TemplateField HeaderText="End Date">
                                                                                        <ItemTemplate>
                                                                                            <div align="left">
                                                                                                &nbsp;<asp:Label ID="lbledDate" runat="server" Text='<%#Bind("U_Z_EndDate") %>'></asp:Label></div>
                                                                                        </ItemTemplate>
                                                                                    </asp:TemplateField>
                                                                                    ...
                                                                                    <asp:TemplateField HeaderText="ReJoin Date">
                                                                                        <ItemTemplate>
                                                                                            <div align="left">
                                                                                                &nbsp;<asp:Label ID="lblRejoin" runat="server" Text='<%#Bind("U_Z_ReJoiNDate") %>'></asp:Label></div>
                                                                                        </ItemTemplate>
                                                                                    </asp:TemplateField>
                                    ...
                                    <asp:Panel ID="PanelNewRequest" runat="server" Width="100%" BorderColor="LightSteelBlue"
                                        ...
                                        <table width="100%" border="0" cellspacing="0" cellpadding="3" class="main_content">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <asp:TextBox ID="txtnodays" CssClass="txtbox" runat="server" AutoPostBack="true"
                                                        Enabled="false" onkeypress="AllowNumbers(this);checkDec(this);RemoveZero(this);"
                                            ...
                                            <tr>
                                             ...
                                             <tr>
                                                ...
                                                <td>
                                                    <asp:TextBox ID="txtrejoin" CssClass="txtbox" runat="server" Visible="false"></asp:TextBox>
                                                    <ajx:CalendarExtender ID="CalendarExtender3" Animated="true" Format="dd/MM/yyyy"
                                                        runat="server" TargetControlID="txtrejoin" CssClass="cal_Theme1">
                                                    </ajx:CalendarExtender>
                                                </td>
                                            </tr>
                                            <tr>
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Approved By">
                                          ...
                                          <asp:TemplateField HeaderText="Next Approver">
                                            <ItemTemplate>
                                                <div align="center">
                                                    <asp:Label ID="lblhapprover" runat="server" Text='<%#Bind("U_Z_NxtApprover") %>'></asp:Label></div>
                                            </ItemTemplate>
                                        </asp:TemplateField>
