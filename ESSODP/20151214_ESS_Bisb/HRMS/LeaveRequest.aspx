<%@ Page Title="Leave Request" Language="vb" AutoEventWireup="false" MasterPageFile="~/HRMS.Master"
    CodeBehind="LeaveRequest.aspx.vb" Inherits="HRMS.LeaveRequest" %>
                                ...
                                <asp:GridView ID="grdRequesttohr" runat="server" CellPadding="4" ShowHeaderWhenEmpty="true"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Next Approver">
                                            <ItemTemplate>
                                                <div align="left">
                                                    &#160;<asp:Label ID="lblhnxtapp" runat="server" Text='<%#Bind("U_Z_NxtApprover") %>'></asp:Label></div>
                                            </ItemTemplate>
                                        </asp:TemplateField>
