...
Public Class RptMonthPaySlip
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "HRMS.RptMonthPaySlip.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_U_Z_empid() As CrystalDecisions.[Shared].IParameterField
        Get
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_U_Z_RefCode() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedRptMonthPaySlip
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptMonthPaySlip = New RptMonthPaySlip()
        rpt.Site = Me.Site
        Return rpt
    End Function
