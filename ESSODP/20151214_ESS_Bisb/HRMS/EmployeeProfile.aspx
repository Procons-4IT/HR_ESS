<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/HRMS.Master" CodeBehind="EmployeeProfile.aspx.vb" Inherits="HRMS.EmployeeProfile" %>
...
--%>
            ...
            <td colspan="5"></td>
             ...
             <tr>
                 <td>ID No.</td>
                 <td>
                 <asp:Label ID="lblgovid"  CssClass="txtbox" Width="150px" runat="server" Enabled="false"></asp:Label>  
                 </td>
                  <td></td>
